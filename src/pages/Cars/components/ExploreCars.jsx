...
import { FaUser, FaLeaf, FaCar, FaCog, FaGasPump, FaHeart } from "react-icons/fa";
      ...
      <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredCars.length > 0 ? (
          filteredCars.map((car) => (
            <div key={car.id} className="bg-inhiret border border-white rounded-2xl shadow-md p-4">
              <img src={car.carImages[0]} alt={car.name} className="w-full h-60 object-cover rounded-lg" />
          ...
          <div className="ml-[380px]">
                      <button className="w-46  px-2 py-4 bg-blue-500 text-white rounded-2xl hover:bg-blue-400 transition duration-300">
                            Load more
                          </button>
                      </div>
